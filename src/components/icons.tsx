/**
 * Brand marks, which lucide deliberately doesn't ship, plus the one mail glyph
 * that has to match their weight. Shared by the About page and the research
 * section; anything lucide has should be imported from lucide-react instead.
 */
